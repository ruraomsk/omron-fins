...
class FwDiag extends FwBaseMess
{
    ...
    {
        this.datas = new ArrayList(FwUtil.VALUE_UIDS);
        this.Skp = new byte[3];
    ...
    /**
     * Загружает в сообщение сотояние одной переменной диагностики Не забываем
     * что uId и код состояния обрезаются до одного байта
     *
     * @param uId
     * @param code
     */
