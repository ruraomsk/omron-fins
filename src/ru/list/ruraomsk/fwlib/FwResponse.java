...
public class FwResponse
{
    ...
    FwResponse(int controller, byte functionCode,int len, byte[] buffer,FwRegisters tableDecode)
    {
        ...
        switch (functionCode)
        {
            ...
            case FwUtil.FP_CODE_34H:
                //info=new FwSetup(buffer,controller);
                break;
            ...
            default:
            { 
                if(FwUtil.FP_DEBUG) System.err.println("Bad function code.");
    ...
    {
        if (getFunctionCode()==FwUtil.FP_CODE_INFO) return (FwInfo) info;
        return null;
    }
    ...
    {
        if (getFunctionCode()==FwUtil.FP_CODE_35H) return (FwKvit) info;
        return null;
    }
     ...
     * @return the otvet
     */
    public FwSetup getOtvet()
    {
        if (getFunctionCode()==FwUtil.FP_CODE_34H) return (FwSetup) info;
        return null;
    }
    ...
    {
        if (getFunctionCode()==FwUtil.FP_CODE_91H) return (FwSyncTime) info;
        return null;
    }
    ...
    {
        if (getFunctionCode()==FwUtil.FP_CODE_64H) return (FwMesLive) info;
        return null;
    }
    public FwMesCtrl getMesCtrl()
    {
        if (getFunctionCode()==FwUtil.FP_CODE_10H) return (FwMesCtrl) info;
        return null;
    }
    ...
    {
        if (getFunctionCode()==FwUtil.FP_CODE_30H) return (FwDiag) info;
        return null;
    }
}
